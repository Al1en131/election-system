...
export default function AddUserPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    role: "student",
    password: "", // biasanya ada password untuk register
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      alert("Terjadi kesalahan saat register user.");
    }
  };
  return (
    <div className="flex min-h-screen bg-gray-50 font-sans">
      ...
      <main className="flex-1 p-8 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-lg shadow border text-[#0B7077] border-[#0B7077] p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border px-3 py-2 rounded focus:ring focus:ring-[#0B7077]"
                required
              />
            </div>
            <div>
